...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (1, 1, 17)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = 6  # Number of dimensions in the action space
        ...
        ### Replay Buffer
        self.replay_buffer_size = 600  # Number of self-play games to keep in the replay buffer
