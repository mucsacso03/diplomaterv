...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (1, 1, 15)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
...
class Game(AbstractGame):
    ...
    def __init__(self, seed=None):
        self.env = gym.make("HopperBulletEnv-v0")
        if seed is not None:
            self.env.seed(seed)
