...
class MuZeroConfig:
    def __init__(self):
        ...
        self.action_space = 3  # Number of dimensions in the action space
        ...
        self.ratio = 1/10  # Desired training steps per self played step ratio. Equivalent to a synchronous version, training can take much longer. Set it to None to disable it
        # fmt: on
